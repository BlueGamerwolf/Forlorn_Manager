...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('clanleader')
        .setDescription('Commands for Clan Co-Leaders')
    ...
    async execute(interaction) {
        ...
        if (!member.roles.cache.has(Roles.CLAN_COLEADER)) {
            return interaction.reply({ content: "You must be a Clan Co-Leader to run this command.", ephemeral: true });
        }
        ...
        if (subcommand === 'kick') {
            ...
            await targetMember.kick(`Kicked by Clan Co-Leader ${interaction.user.tag}`);
